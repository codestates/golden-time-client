...
const NaviPresenter = ({ isLogin, currentLocation, search, isModal, handleLocalLogin, handleInputValue, handleLogout, handleIsModal }) => (
  <Container>
    <Link to='/'>
      <Home>
    ...
    {currentLocation === null ? <Location>위치 정보를 확인하는 중입니다.</Location> :
      currentLocation === false ? <Location>위치 정보를 받아올 수 없습니다.</Location> :
