...
const GoodsDetailPresenter = ({
  ...
  return (
    <MainContainer>
      <SubContainer>
        <ImageContainer>
          <FaRegCaretSquareLeft size="50" color='rgb(186,185,184)' onClick={handleBeforeImage} />
          <Image src={images[imageNum]} />
          <FaRegCaretSquareRight size="50" color='rgb(186,185,184)' onClick={handleNextImage} />
        </ImageContainer>
        <ContentsContainer>
